    ...
    <div class="row px-xl-5">
        <div class="col-lg-7 mb-5">
            <div class="contact-form bg-light p-30">
                <div id="success"></div>
                <form name="sentMessage" id="contactForm" novalidate="novalidate" method='post' action={{route('send#message')}}>
                    @csrf
                    ...
                    <div>
                        <button class="btn btn-primary py-2 px-4" type="submit" name="sendMessageButton">Send
                            Message</button>
                    </div>
                </form>
            </div>
